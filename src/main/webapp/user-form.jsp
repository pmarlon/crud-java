...
<html>
<head>
<title>Viagem Legal! Agencia</title>
<link rel="stylesheet"
...
<body style="font-family: 'Lato', sans-serif">
	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark" style="background: #ffc67b;">
			<div>
				<a href="list" class="navbar-brand" style="color: #000000;">Viagem Legal!</a>
			</div>

			<ul class="navbar-nav">
				<li><a href="<%=request.getContextPath()%>/list"
					class="nav-link" style="color: #000000;">Destinos</a></li>
			</ul>
		</nav>
	</header>
	<br>
